...
import pl.pierogi.repository.BikeRepository;
...
/**
 * REST controller for managing {@link pl.pierogi.domain.Bike}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BikeResource {
    ...
    public ResponseEntity<Bike> updateBike(@RequestBody Bike bike) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, bike.getId().toString()))
            .body(result);
    }
